...
@section('content')
      <div class="flex h-screen antialiased text-gray-800">
        <div onload="scroll(this)"  class="flex md:flex-row flex-col h-auto w-full overflow-x-hidden">
            <div class='md:hidden flex content-start items-center sticky top-0 bg-white w-full z-50 h-36  cursor-pointer mr-auto  mt-8' onclick='showSidbar()'>
                <svg class='mr-auto ml-10 ' width="47" height="26" viewBox="0 0 47 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="sidbar" class="md:transform -translate-x-96 transition-all duration-75 hidden md:flex fixed flex-col h-full  md:sticky top-0 py-8 pl-4 pr-4 md:w-64 w-full z-50  bg-white flex-shrink-0">
                ...
                <div class="flex  flex-row items-center justify-between h-12 w-full">
                    <div class="flex items-center justify-around rounded-2xl text-indigo-700 bg-indigo-100 h-10 md:w-full sm:w-1/2 w-3/4">
                        ...
                        <p class="text-gray-800 font-bold pr-4">Abubakr Alameri</p>
                    </div>
                ...
                <div
                    ...
                    <form action="" method="post" class="w-full h-full">
                        <input type="text" class="h-10 w-8/12 rounded-lg ">
            ...
            <div class="flex flex-col flex-auto min-h-0 p-4 ">
                <!--! sratr chat content -->
                <div class="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 min-h-0 p-4">
                    <div class="flex flex-col h-full overflow-x-auto mb-4">
                        <div class="flex flex-col h-full overflow-x-hidden">
                            <div id="chat" class=" grid grid-cols-12 gap-y-2">
                                ...
                                <!-- <div class="col-start-1 col-end-11 md:col-end-8 p-2 rounded-lg">
                                    <div class="flex flex-row items-center">
                                        <div
                                            class="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0">
                                            A
                    ...
                    <!--! start chat footer -->
                    <div class="h-auto rounded-xl bg-white  p-2">
                        ...
                        <form class="flex-grow ml-1  min-h-0">
                            <div class="w-full  min-h-0">
                                    <textarea id="inputText" type="text" style=' resize: none;'
